...
import Chill_img from '../../assets/chill_img.png'
...
export default function Playlist() {
  ...
  const newPlaylist = async () => {
    try {
      let response = fetch(`https://api.spotify.com/v1/browse/categories/${id}/playlists`,
      {
        "Authorization" : ACCESS_TOKEN
      }
      );
      let { data } = await response.json()
      setGetPlaylist(data.items);
      ...
      <div className="navbar">
        ...
        <main className='main2'>
            <div className="public_section">
                ...
                <div className="public_play">
                    <div className="public_img">
                        <img src={Chill_img} alt="chill" />
                    </div>
                    <div className="play_text">
                        <h4>PUBLIC PLAYLIST</h4>
                        <h2>Chill Mix</h2>
                        <p>Julia Wolf, ayokay, Khalid <span>and more</span></p>
                        <p><span>Made for</span> davedirect3 <img src={Circle_img} alt="circle" /> <span>34 songs, 2hr 01 min</span></p>
                    </div>
                </div>
                <div className="public_playlists">
